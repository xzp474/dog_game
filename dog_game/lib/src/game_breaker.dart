...
class GameBreaker extends FlameGame with TapDetector {
  ...
  void cleanGame() {
    world
      ..removeAll(world.children.query<FollowTarget>())
      ..removeAll(world.children.query<Dog>())
      ..removeAll(world.children.query<Ball>())
      ..removeAll(world.children.query<Background>())
      ..removeAll(world.children.query<Ground>());
  }
